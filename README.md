...
![屏幕预览](docs/images/screen-v14.1.png)
...
![参考面板与实现对照](docs/images/reference-vs-v14.1.png)
...
当前 **v14.1**。完整历史与每个发布固件的 SHA256 见 [CHANGELOG.md](CHANGELOG.md)。
...
│                                          │
│ 八月初二 11天后秋分    ⚡ [B2A1] / v14.1  │  行3 符文槽 172..179（固定）
└──────────────────────────────────────────┘
...
1. **大时钟是手绘的，不是字体。** 字号 40 的 `DSEG14` 宽高比 0.85，要 68 px 高就得
   ...
   整体裁掉 —— 镜像 91260 B（v13.0）→ **82468 B（v14.1）**，反而小了 8.6 KB。
